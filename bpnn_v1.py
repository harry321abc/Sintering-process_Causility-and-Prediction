# -*- encoding: utf-8 -*-
'''
@Time    :   2020/04/22 11:47:26
@Author  :   Haoran Li 
@Contact :   lihr16@163.com
@Desc    :   BPNN model v1: 1 hidden layer,对于不同预测变量，需修改：obs,pkl名称,train图标题，test图标题、坐标轴、保存文件名
'''
...
plt.savefig('./bpnn_v1_5_train.png')
plt.show()

# print('Loss=%.4f' % loss.data.numpy())
torch.save(net, 'bpnn_v1_5.pkl') 
# test
net2 = torch.load('bpnn_v1_5.pkl')
...
plt.savefig('./bpnn_v1_5_test.png')
plt.show()